...
assert.strictEqual(topByName['API Testing'].score, 0);
assert.strictEqual(topByName['API Testing'].dev2vecStatus, 'weak');
assert.strictEqual(topByName.Database.dev2vecStatus, 'matched');
assert.strictEqual(missingByName['REST API'].dev2vecStatus, 'missing');
