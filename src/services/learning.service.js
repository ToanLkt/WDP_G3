...
const buildLearningTopicProfile = ({ skillName, targetRole, level, language, taskTitle = '', taskDescription = '', projectType = '' }) => {
  ...
  const rules = [
    ...
    { pattern: /rbac|role[- ]based access|phân quyền|phan quyen|authorization middleware/i, primaryTopic: 'JWT RBAC authorization middleware Node.js Express', query: 'JWT RBAC authorization middleware Node.js Express tutorial', terms: ['jwt', 'rbac', 'role based access control', 'authorization', 'middleware', 'node.js', 'express'], requiredTermGroups: [['rbac', 'role based access control'], ['jwt', 'authentication', 'authorization'], ['node.js', 'nodejs', 'express', 'express.js']], excludedTerms: ['django', 'spring boot', 'asp.net', '.net', 'laravel'] },
    { pattern: /jwt|auth|authentication|authorization|login|token/i, query: 'JWT authentication middleware Node.js Express', terms: ['jwt', 'authentication', 'authorization', 'middleware', 'node.js', 'express'], requiredTermGroups: [['jwt', 'authentication'], ['middleware', 'authorization', 'auth']], excludedTerms: ['python', 'django', '.net', 'asp.net', 'spring boot', 'java'] },
    ...
    { pattern: /\bapi\b|\bcrud\b|\bendpoint\b|\broute\b|\bcontroller\b/i, primaryTopic: 'REST API endpoint implementation', query: 'REST API CRUD endpoint Node.js Express tutorial', terms: ['rest api', 'crud', 'endpoint', 'controller', 'node.js', 'express'] },
